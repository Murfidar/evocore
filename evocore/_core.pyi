...
def candidate_id(master_seed: int, event_index: int, candidate_index: int) -> str: ...
def rank_top_k(scores: Sequence[float], trusted_mask: Sequence[bool], k: int) -> list[int]: ...
